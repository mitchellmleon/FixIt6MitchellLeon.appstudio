...
const cacheName = 'fixit6MitchLeon-2020-11-18 00:02:50.331003'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit6MitchLeon'.length) === 'fixit6MitchLeon') {
